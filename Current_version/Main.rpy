...
label goodname:
    ...
    length=12, default="", 
    allow="абвгдеёжзийклмнопрстуфхцчшщъыьэюя-АБВГДЕЁЖЗИЙКЛМНОПРСТУФХЦЧШЩЪЫЬЭЮЯ0123456789") .strip()
    ...
    user "Да. Привет,Славя. {w}А я [ggname]."
    ...
    sl "Очень приятно. {w}Ну так что, пойдем? Остальные девочки уже ждут."
